...
const Ingredients = ({ ingredients, setIngredients }) => {
  ...
  const searchRecipesByIngredients = async () => {
    ...
    const response = await fetch(
      `https://api.spoonacular.com/recipes/findByIngredients?apiKey=${API_KEY}&number=${recipesNumber}&ranking=2&ingredients=${query}`
    )
